...
router.get('/',(req,res,next)=>{
  ...
  res.render('shop',{prods:products,docTitle:'Shop', path:'/',hasProducts: products.length > 0, activeShop:true,productCSS: true
                    }); //seting layout: false will not use default layout
});
 
module.exports = Router;


//views//layout/main-layout.hbs
...
<body>
<header>
 <a class="{{#if activeShop }} active {{/if}}" href="/"></a>
 <a class="{{#if activeAddProduct }} active {{/if}}" href="/"></a>
</header>
