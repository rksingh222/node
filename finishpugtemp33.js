...
<body>
  ...
  <li class="main-header__item"><a class="activve" href="/">shop</a></li>
...
html(lang="en")
   head
      meta()
      title Document
      title #{pageTitle} //every render function passes pageTitle
      link(rel="stylesheet", href="/css/main.css")
     ...
     header.main-header(add indentation level and use tab for getting (
          nav.main-header__nav
                ul.main-header__item-list
                   ...
                   li.main-header__item
                        a(href="/admin/add-product", class=(path === '/admin/add-product'? 'active':'')) Add Product //we can add class also as attribute if we want to check
      block content
